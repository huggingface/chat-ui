 ...
 *
 * The behavioral spec lives in `src/lib/utils/scroll/__tests__` (unit level)
 * and `docs/scroll/` (prose); these tests pin the end-to-end wiring — turn
 * groups, clearance padding, the anchor latch — that only the full page
 * exercises.
 */
