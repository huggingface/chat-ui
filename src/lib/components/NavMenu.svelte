...
>
	<button
		class="mx-auto flex w-full flex-row items-center justify-stretch gap-x-2 rounded-xl px-2 py-1 align-middle text-gray-600 hover:bg-gray-500/20 dark:text-gray-400"
		onclick={() => {
			closeMobileNav();
			toggleSearch();
		}}
	>
		...
		<span class="ml-auto text-xs text-gray-500">ctrl/cmd k</span>
	</button>
