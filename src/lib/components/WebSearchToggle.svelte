...
>
	...
	<div class="whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">Agents ✨</div>
	<div class="group relative w-max">
		...
		>
			<p class="max-w-sm text-sm text-gray-800 dark:text-gray-200">
				When enabled, the model might try to use tools to search the web for an answer or to produce
				audio and images.
			</p>
		</div>
	</div>
