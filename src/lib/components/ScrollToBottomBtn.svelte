...
{#if visible}
	<button
		...
		class="btn absolute flex rounded-full border w-[41px] h-[41px] shadow-md dark:shadow-gray-950 bg-white dark:bg-gray-700 hover:bg-slate-100 dark:hover:bg-gray-600 dark:border-gray-600 transition-all {className}"
