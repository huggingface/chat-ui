...
{#if message.from === 'assistant'}
	<div class="flex items-start justify-start gap-4 leading-relaxed">
		...
		/>
		<div
			class="relative rounded-2xl px-5 py-3.5 border border-gray-100 bg-gradient-to-br from-gray-50 dark:from-gray-800/40 dark:border-gray-800 prose text-gray-600 dark:text-gray-300 dark:prose-invert"
			bind:this={el}
		>
			{@html html}
		</div>
