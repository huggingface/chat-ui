				...
				<div class="flex items-center">
					...
					>
						<DropdownMenu.Trigger
							class="btn size-9 rounded-full border bg-white text-black shadow transition-none enabled:hover:bg-white enabled:hover:shadow-inner dark:border-transparent dark:bg-gray-600/50 dark:text-white dark:hover:enabled:bg-gray-600 sm:size-8"
							disabled={loading}
					...
					{#if $enabledServersCount > 0}
						<div
							class="ml-2 inline-flex h-9 items-center gap-2 rounded-full border border-blue-500/10 bg-blue-600/10 pl-2.5 pr-1.5 text-sm font-semibold text-blue-700 dark:bg-blue-600/20 dark:text-blue-400 sm:h-8"
