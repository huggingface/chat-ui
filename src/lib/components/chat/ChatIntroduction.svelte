...
<div
	class="flex-grow flex-shrink w-full mr-1 self-center items-center flex flex-col gap-5 overflow-y-auto scrollbar-custom"
>
	<div class="max-w-3xl xl:max-w-4xl grid lg:grid-cols-3 gap-8 px-5 pt-6 my-auto">
