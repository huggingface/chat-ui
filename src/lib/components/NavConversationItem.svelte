...
<div
	class="group flex h-8 flex-none items-center gap-1.5 rounded-lg pl-2 pr-1.5 text-sm text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 max-sm:h-10
