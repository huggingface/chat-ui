...
<a
	...
	class="group flex h-10 flex-none items-center gap-1.5 rounded-lg pl-3 pr-2 text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700 {conv.id ===
	$page.params.id
