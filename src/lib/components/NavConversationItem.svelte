...
<a
	...
	class="group flex h-11 flex-none items-center gap-1.5 rounded-lg pl-3 pr-2 text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-gray-200 {conv.id ===
	$page.params.id
		? 'bg-yellow-800 dark:text-gray-600'
		: ''}"
>
