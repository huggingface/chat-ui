...
<Modal on:close>
	<div class="flex w-full flex-col gap-5 p-6">
		...
		>
			...
			<button
				type="submit"
				class="mt-2 rounded-full bg-yellow-800 px-5 py-2 text-lg font-semibold text-gray-800 ring-gray-400 ring-offset-1 transition-all focus-visible:outline-none focus-visible:ring hover:ring"
			>
				Apply
			</button>
		</form>
