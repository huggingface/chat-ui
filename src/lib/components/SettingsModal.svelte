		...
		>
			{#if PUBLIC_APP_DATA_SHARING}
				<label class="flex cursor-pointer select-none items-center gap-2 text-gray-500">
					...
					/>
					Compartir conversación con los autores del modelo
				</label>

				<p class="text-gray-800">
					Compartir tus datos ayuda a mejorar el modelo en el tiempo.
				</p>
				<p class="text-gray-800">
					Lo puedes cambiar en cualquier momento, aplica a todas tus conversaciones.
				</p>
				<div>
					<p class="text-gray-800">Leer más sobre los autores del modelo:</p>
		...
		{#if isConfirmingDeletion}
			<Modal on:close={() => (isConfirmingDeletion = false)}>
				...
				>
					...
					<p class="text-gray-800">
						Esta acción borrará todas tus conversaciones y no se puede deshacer
					</p>
					<button
						type="submit"
