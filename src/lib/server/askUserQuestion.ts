								...
								items: {
									...
									properties: {
										label: {
											type: "string",
											description:
												"The choice, in a few words. In a budget question, a label that names a dollar amount must carry setBudgetUsd.",
										},
										description: {
											type: "string",
											description:
												"What picking this means, and its trade-off. What the choice costs goes here, not in the label.",
										},
										setBudgetUsd: {
											type: "number",
											description:
