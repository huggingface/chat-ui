<script lang="ts">
	...
	// is full frame if the path ends in /new or /edit
	$: isFullFrame = $page.url.pathname.endsWith("/new") || $page.url.pathname.endsWith("/edit");
</script>
			...
			>
				...
				{#if data.enableAssistants}
					<h3
						...
						class="pb-3 pl-3 pt-5 text-[.8rem] text-gray-800 sm:pl-1"
					>
						Assistants
					</h3>
