...
<svelte:head>
	<meta property="og:title" content={modelId + " - " + env.PUBLIC_APP_NAME} />
	<meta property="og:type" content="link" />
	<meta property="og:description" content={`Use ${modelId} with ${env.PUBLIC_APP_NAME}`} />
	<meta
		property="og:image"
		content="{env.PUBLIC_ORIGIN || $page.url.origin}{base}/models/{modelId}/thumbnail.png"
	/>
