...
>
	...
	>
		<div class="flex-none sticky top-0 gap-2 px-3 py-4 flex justify-between items-center">
			<div class="flex items-center font-bold gap-0.5 text-lg">
				<Logo
					classNames="text-3xl translate-y-[2.5px] {$page.url.pathname == '/'
			...
			<a
				...
				class="{$page.url.pathname == '/'
					? 'opacity-50'
					: ''} border flex items-center text-gray-600  pl-1.5 pr-2 py-1.5 w-full justify-center shadow hover:shadow-sm rounded-lg bg-white dark:bg-gray-700 dark:border-gray-600 text-center text-sm"
			>
				New Chat
			</a>
		</div>
		<div class="flex flex-col overflow-y-auto px-3 pb-3 gap-1">
