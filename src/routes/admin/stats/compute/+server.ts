...
export async function POST() {
	for (const span of ["day", "week", "month"] as const) {
		computeStats({ dateField: "updatedAt", type: "conversation", span }).catch(e => logger.error(e));
		computeStats({ dateField: "createdAt", type: "conversation", span }).catch(e => logger.error(e));
