	...
	<div class="mt-10 grid w-fit grid-cols-1 gap-4 p-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
		{#each data.assistants as assistant}
			<a
				...
				class="flex h-72 flex-col items-center gap-2 rounded-xl border-2 border-gray-300 bg-gray-100 bg-gradient-to-tr from-gray-200 to-gray-50 p-4 transition-all hover:-translate-y-1 dark:border-gray-700 dark:bg-gray-800 dark:from-gray-900 dark:to-gray-800"
			>
				{#if assistant.avatar}
					<img
